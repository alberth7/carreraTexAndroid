...
public class Textura {
	...
	public void setCoord_Textura(float u1, float v1, float u2, float v2) {
		...
		coord_textura[0] = u1; coord_textura[1] = v2; // 3
		coord_textura[2] = u2; coord_textura[3] = v2; // 2
		coord_textura[4] = u2; coord_textura[5] = v1; // 1
		coord_textura[6] = u1; coord_textura[7] = v1; // 0
...
//					GL10.GL_CLAMP_TO_EDGE);
			...
			Log.d("Rectangulo", "No puede cargar " + nombreDeArchivo);
